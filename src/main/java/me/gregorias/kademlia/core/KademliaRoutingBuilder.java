 ...
 * to:
 * 1. Set {@link me.gregorias.kademlia.network.ByteListener} only once.
...
public class KademliaRoutingBuilder {
  ...
  /**
   * Set {@link me.gregorias.kademlia.network.ByteSender} used for sending messages.
   *
  ...
  /**
   * Set {@link me.gregorias.kademlia.network.ByteListeningService}.
   *
